...
namespace BehaviorTree 
{
    public static class BehaviorTreeMan
    {
        ...
        public static ActionNode ActionN(Action action) => new ActionNode(action); // ActionNode
        public static ConditionNode IF(Func<bool> condition) => new ConditionNode(condition); // Condition
        public static NotConditionNode NotIf(Func<bool> condition) => new NotConditionNode(condition); // NotIF
